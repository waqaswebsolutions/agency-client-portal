  ...
  return (
    <div className="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-30">
      <div className="flex items-center h-16 px-6 border-b border-gray-200">
        <Link href="/dashboard" className="text-xl font-bold text-indigo-600 cursor-pointer hover:text-indigo-700 transition-colors">
          AgencyPortal
        </Link>
      </div>
      <nav className="p-4 space-y-1">
        {navigation.map((item) => {
          ...
          return (
            ...
            >
              <span className={active ? "text-indigo-600" : "text-gray-400 group-hover:text-indigo-600"}>
                {item.icon}
              </span>
              {item.name}
            </Link>
